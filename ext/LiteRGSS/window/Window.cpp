...
// Store base size to allow rescaling
...
// scale_window(scale) - rescale the window keeping the base size
...
// resize_screen(width, height) - change the base size and resize the window
