...
void Init_Gamepad()
{
    ...
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_FACE_LEFT", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_RIGHT_FACE_LEFT));
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_FACE_RIGHT", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_RIGHT_FACE_RIGHT));
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_FACE_UP", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_RIGHT_FACE_UP));
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_THUMB", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_RIGHT_THUMB));
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_TRIGGER_1", LONG2NUM(raylib::GAMEPAD_BUTTON_RIGHT_TRIGGER_1));
    rb_define_const(rb_mGamepad, "BUTTON_RIGHT_TRIGGER_2", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_RIGHT_TRIGGER_2));
    rb_define_const(rb_mGamepad, "BUTTON_UNKNOWN", LONG2NUM(raylib::GamepadButton::GAMEPAD_BUTTON_UNKNOWN));
